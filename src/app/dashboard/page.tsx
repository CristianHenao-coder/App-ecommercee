...
export default function DashboardPage() {
  ...
  if (loading) {
    return (
      <Box sx={{ display: "flex", justifyContent: "center", alignItems: "center", minHeight: "100vh", bgcolor: "black", color: "white" }}>
        <CircularProgress />
    ...
    <main className="min-h-screen bg-black text-white px-6 py-12">
      ...
      <TableContainer component={Paper} sx={{ bgcolor: "#111", color: "white" }}>
        <Table sx={{ minWidth: 650 }} aria-label="simple table">
          <TableHead>
            <TableRow>
              <TableCell sx={{ color: "gray" }}>{t("dashboard.image")}</TableCell>
              <TableCell sx={{ color: "gray" }}>{t("dashboard.name")}</TableCell>
              <TableCell sx={{ color: "gray" }}>{t("dashboard.category")}</TableCell>
              <TableCell sx={{ color: "gray" }} align="right">{t("dashboard.price")}</TableCell>
              <TableCell sx={{ color: "gray" }} align="right">{t("dashboard.actions")}</TableCell>
            </TableRow>
          </TableHead>
          <TableBody>
            {isLoadingProducts ? (
