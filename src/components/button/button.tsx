...
export default function Button({
    ...
    const variants = {
        primary: "bg-blue-600 hover:bg-blue-700 text-white shadow-lg hover:shadow-blue-500/50 border border-transparent",
        ...
        danger: "bg-red-600 hover:bg-red-700 text-white shadow-lg hover:shadow-red-500/50 border border-transparent",
    };
